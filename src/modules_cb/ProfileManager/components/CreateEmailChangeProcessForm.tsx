...
import {changeProcess, showEmailChangeProcessForm, showEmailCreateForm} from "../redux/actions";
import {FormComponentProps} from "antd/lib/form";
import {Button, Form, Icon, Input, Modal, Select} from "antd";
import React, {FormEvent, useEffect, useRef, useState} from "react";
import {ChangeProcessRequest, MailForm, MailRequest} from "../types";
...
import {formats, modules} from "src/helpers/utilsFunc";
...
function CreateEmailChangeProcessForm(props: IProps) {
  ...
  function onBtnCancelClicked() {
    resetFields();
    props.showEmailChangeProcessForm(false);
    setValueEditor("")
    setEmailTemp([])
  }
      ...
      <div>
        <div>
          <Modal
            zIndex={2}
            maskClosable={false}
            visible={props.showBooking.show_email_change_process}
            centered={true}
            width="700px"
            className="custom"
            ...
            <div className="footer-right">
              ...
              <Button type={"primary"} onClick={handleSubmitForm}>Chuyển vòng và gửi mail</Button>
            </div>
          </Modal>
        </div>
...
export default connector(Form.create<IProps>()(CreateEmailChangeProcessForm));
