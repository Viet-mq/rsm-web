...
import {createAddress, showFormCreate} from "../redux/actions";
import {CreateAddressRequest} from "../types";

const mapStateToProps = ({addressManager}: RootState) => ({addressManager});
const connector = connect(mapStateToProps, {createAddress, showFormCreate});

type ReduxProps = ConnectedProps<typeof connector>;

interface CreateAddressFormProps extends FormComponentProps, ReduxProps {
}
...
function CreateAddressForm(props: CreateAddressFormProps) {
  ...
  return (
    ...
    <Modal
      ...
      visible={props.addressManager.showForm.show_create}
      centered={true}
      width="550px"
      afterClose={() => {
        resetFields();
      ...
      <Form {...formItemLayout}>
        ...
        <Form.Item label="Địa chỉ" className="mb-0" style={{...formItemStyle}}>
          ...
          })(<Input placeholder="Nhập Địa chỉ" className="bg-white text-black"/>)}
        </Form.Item>
...
export default connector(Form.create<CreateAddressFormProps>()(CreateAddressForm));
